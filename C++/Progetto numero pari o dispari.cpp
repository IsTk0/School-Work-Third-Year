...
int main(){
	...
	cout << "Questo programma capisce il numero da te inserito Ž pari o dispari. Prova tu a inserirne uno qui: ";
	...
	if (numero_inserito%2 == 0) {
		cout << "Il numero da te inserito Ž pari";
	}
	else {
		cout << "Il numero da te inserito Ž dispari";
	}
}
